...
class AIService {
    ...
    func processText(_ text: String, completion: @escaping (ZhipuAIResponse?) -> Void) {
        ...
        支付方式选项：现金、招商银行卡、中信银行卡、交通银行卡、建设银行卡、工商银行卡、农业银行卡、中国银行卡、民生银行卡、光大银行卡、华夏银行卡、平安银行卡、浦发银行卡、兴业银行卡、信用卡、招商信用卡、建行信用卡、工行信用卡、微信、支付宝、Apple Pay、Samsung Pay、云闪付、数字人民币、银行转账、网银转账、手机银行
